...
public class AngleShooter : MonoBehaviour {
	...
	void OnGUI(){
		windowRect = GUI.Window (15, new Rect ((Screen.width - box_w)/16, (Screen.height - box_h) - 70 , box_w, box_h), DoMyWindow3, "Angle (Angle : Easy)");
	...
	void DoMyWindow(int windowID) {
		...
		int text_h = 80;
		int text_w = 50;
		GUI.Label (new Rect (70, 40, 300, 70), "Great! You're getting the Angle down well. Did you know there are multiple Angles that allow " +
			"you to hit the target? Try them in the tutorial or move on to the next challenge.", myStyle);
	...
	void DoMyWindow3(int windowID) {
		...
		GUI.Label (new Rect (110, 80, 130, 30), "Velocity: 900 Meters Per Second", myStyle);
